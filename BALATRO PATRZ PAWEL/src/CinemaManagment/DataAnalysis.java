...
public class DataAnalysis{
    public String getBestSellerDrinkName(){
    ...
    public String getBestSellerSnackName(){
    ...
    public String getBestSellerSetName(){
    ...
    public ArrayList<Customers> getCustomersByGender(char gender){
    ...
    public ArrayList<Customers> getCustomersByAgeRange(int start, int end){
        ArrayList<Customers> sortedCustomers = new ArrayList<Customers>();
        if(!(Cinema.getCinemaCustomers().isEmpty())){
            for(Customers c: Cinema.getCinemaCustomers()){
    ...
    public void dumpCustomerData(String filename, ArrayList<Customers>customerList)throws IOException{
