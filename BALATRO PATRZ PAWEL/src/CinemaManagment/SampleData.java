...
public class SampleData {
    public static void createSampleCustomers() throws NoSuchAlgorithmException{
        Customers s1 = new Customers("Veera", "De Leon", 11, 9, 2001, "WTC2001!", "boeingLover@gmail.eu", 'm');
        Customers s2 = new Customers("Shreya", "Berry", 15, 11, 1999, "QWEERTY2!", "yes@auto.vroom", 'f');
        Customers s3 = new Customers("Lilly", "O'Quinn", 1, 1, 1970, "Lilyofthevalley22!", "lily@interia.eu", 'f');
        Customers s4 = new Customers("Lina", "Mcpherson", 29, 3, 1988, "eH2fVz(M", "devan.yang@hotmail.com", 'f');
        Customers s5 = new Customers("Alexandra", "Lam", 31, 7, 2003, "a!7=yq[X", "jaida.stein@outlook.com", 'm');
        Customers s6 = new Customers("Lucie", "Rowland", 19, 2, 1996, "k*h$Vee9", "pvlvbonfwvn@outlook.com", 'm');
        Customers s7 = new Customers("Tessa", "Oconnell", 11, 9, 1999, "ty8VZ*N&", "arthur.mooney@ymail.com", 'm');
        Customers s8 = new Customers("Rachael", "Marquez", 11, 12, 1987, "q6ZHA{6x", "leo.mullins@msn.com", 'm');
        Customers s9 = new Customers("Rory", "West", 31, 10, 1984, "A%zSV?2>", "brogan.dotson@yahoo.com", 'm');
        Customers s10 = new Customers("Isabel", "Weeks", 19, 1, 1999, "J!H!9=ru", "x1xvbii5xqvwb@googlemail.com", 'm');
        Customers s11 = new Customers("Bonnie", "Vaughn", 1, 5, 1985, "njlgnaNJDES1323", "bret.leach@rediffmail.com", 'f');
        Customers s12 = new Customers("Nancy", "Reyes", 9, 7, 1967, "jgnrwlg#jn34", "gxq3h05emnubt1@googlemail.com", 'm');
        Customers s13 = new Customers("Hayden", "Pennington", 1, 2, 2001, "ILoveFluffyKittens25!@", "boeingLover@gmail.eu", 'm');
        Customers s14 = new Customers("India", "Nunez", 2, 1, 2002, "meowMeow123@", "gallagher.rasmussen@aol.com", 'm');
        Customers s15 = new Customers("Mckenzie", "Preston", 3, 7, 2001, "Qwertq2!", "vyexqcwppft8yo@yahoo.com", 'm');
        Customers s16 = new Customers("Tilly", "Geer", 4, 4, 2001, "nyanyanyaNya1234NYA@@", "kal-el.hayden@rediffmail.com", 'f');
        Customers s17 = new Customers("Eric", "Cartman", 5, 10, 2001, "yeyeyeyeyey1234YE!", "1v1bsuquodevba@googlemail.com", 'm');
        Customers s18 = new Customers("Power", "ChainsawMan", 5, 11, 2002, "coolPassword234!", "s31fpctqgvgv9jr7@aol.com", 'm');
        Customers s19 = new Customers("Reze", "RussianSpy", 6, 11, 2005, "amIrightLol12!", "joshua.gonzalez@comcast.net", 'm');
        Customers s20 = new Customers("Kyle", "Dobrowski", 15,12, 2006, "lol123@", "d74x8c09kaf2@hotmail.com", 'm');
        Customers s21 = new Customers("Kenny", "OMG", 18, 11, 2001, "password@!2", "leo.mullins@msn.com", 'f');
        Customers s22 = new Customers("Another", "Reference", 22, 3, 2007, "moviestarplanet12#", "di3zq7o5micuc60fds@outlook.com", 'm');
        Customers s23 = new Customers("Token", "Black", 11, 9, 2001, "butters!2", "di3zq7o5micuc60fds@outlook.com", 'f');
        Customers s25 = new Customers("Sonic", "The hedgehog", 11, 9, 2001, "kylesmom1sAb8!", "kiegan.norman@msn.com", 'm');
        Customers s26 = new Customers("shadow", "The Hedgehog", 11, 9, 2001, "EricCartman123!@", "rishi.salinas@aol.com", 'm');
        ...
        Cinema.addCustomer(s1);
        Cinema.addCustomer(s2);
        Cinema.addCustomer(s3);
        Cinema.addCustomer(s4);
        Cinema.addCustomer(s5);
        Cinema.addCustomer(s6);
        Cinema.addCustomer(s7);
        Cinema.addCustomer(s8);
        Cinema.addCustomer(s9);
        Cinema.addCustomer(s10);
        Cinema.addCustomer(s11);
        Cinema.addCustomer(s12);
        Cinema.addCustomer(s13);
        Cinema.addCustomer(s14);
        Cinema.addCustomer(s15);
        Cinema.addCustomer(s16);
        Cinema.addCustomer(s17);
        Cinema.addCustomer(s18);
        Cinema.addCustomer(s19);
        Cinema.addCustomer(s20);
        Cinema.addCustomer(s21);
        Cinema.addCustomer(s22);
        Cinema.addCustomer(s23);
        Cinema.addCustomer(s26);
        Cinema.addCustomer(s25);
    ...
    public static void createSampleStaff() throws NoSuchAlgorithmException{
        ...
        Staff s7 = new Staff("Kaai", "Yuuki", "69051936818", 6, 8, 2007, 'f', "barista","InabakumoriReference#23");
