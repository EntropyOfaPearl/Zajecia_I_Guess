...
public class SampleData {
    ...
    public static void createSampleFood() {
        Drinks d1 = new Drinks("Pepsi", 20.00, "Gazowany napój o smaku koli", 500, false, "cola", true, "softdrink");
        Drinks d2 = new Drinks("Pepsi Max", 20.00, "Gazowany napój o smaku koli bez cukru", 500, false, "cola", false, "softdrink");
        ...
        Drinks d7 = new Drinks("Whiskey z kolą", 30.00, "whiskey w swojim ikonicznym połączeniu z kolą", 300, true, "wiskey with coke", true, "alcochol");
        Cafe.addToDrinks(d1);
        Cafe.addToDrinks(d2);
        Cafe.addToDrinks(d3);
        Cafe.addToDrinks(d4);
        ...
        Cafe.addToSnacks(s5);
        Cafe.addToSnacks(s6);
        Sets set1 = new Sets("2 for u", "2 for u tylko że w kinie",s5 ,d2 , 1, 1);
        Sets set2 = new Sets("mexyk", "taco salsa nachos border",s3 ,d2 , 1, 1);
        Sets set3 = new Sets("date idk man", "dawqawddawdasd",s4 ,d2 , 2, 2);
        Sets set4 = new Sets("this would slap on god", "placeholder",s2 ,d7 , 1, 2);
        Sets set5 = new Sets("masochism", "do you hate your self? like really bro who tf eats popcorn while drinking peach lipton",s6 ,d6 , 1, 1);
        Sets set6 = new Sets("placeholder", "placeholder",s4 ,d1 , 2, 1);
        Sets set7 = new Sets("placeholder", "placeholder",s3 ,d3 , 1, 2);
        Sets set8 = new Sets("mechico but alcochol", "placeholder",s3 ,d7 , 1, 2);
        Cafe.addToSets(set1);
        Cafe.addToSets(set2);
        Cafe.addToSets(set3);
        Cafe.addToSets(set4);
